	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="/account/accountList.do"> <img
				width="35px;"
				src='<c:url value="/images/egovframework/common/bil.jpg" />'>
			</a>
		</div>
		...
		<div class="collapse navbar-collapse navbar-right" id="myNavbar">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a class="dropdown-toggle"
					data-toggle="dropdown" href="#">회계관리</a>
			...
			<ul class="nav navbar-nav ">
						<li class="dropdown active"><span><font size="2px"
								color="white"> <br /> ${sessionScope.userid} 님 로그인
							</font></span></li>
						<li class="active"><a href="${path}/login/logout.do"><span
